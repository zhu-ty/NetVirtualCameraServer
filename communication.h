...
{
public:
    CommunicationMessage(){requestor_="";action_=Communication_Thread_Wait;}
    CommunicationMessage(string _requestor,Communication_Action _action){requestor_=_requestor;action_=_action;}
