...
///一些常量的定义
static const int32_t packetDelay=1100;   ///16bit: 1100:max15fps 1800:max10fps        ///1200@30fps; 1300@28fps; 1500@26fps; 1600@25fps; 2200@20fps; 3000@15fps 4500@10fps
//static const int32_t bitMode=0;                ///0:16bit  1:8bit

static const int32_t captureBufferNumber=128;    ///pipeline
static const int32_t ringBufferNumber=32;        ///save image buffer
static const int32_t boxAmountMin=0;
static const int32_t boxAmountMax=2;
static const int32_t cameraAmountMin=0;
static const int32_t cameraAmountMax=2;
static const int32_t imageWidthMin=1280;
static const int32_t imageWidthMax=2560;
static const int32_t imageHeightMin=1080;
...
{
public:
    CameraControlThread(CameraServerUnit *_cameraServerUnit,CameraControlMessageDeque *_cameraControlMessageDeque);
    ~CameraControlThread();
